...
int usage() {
  printf("\ta - Add Accident Character.\n");
  printf("\tF - Add Flying Objects.\n");
  printf("\tl - Add SL Logo.\n");
  printf("\tt - Set time.\n");
  printf("\tr - Display Rnadom option -a, -F, -l.\n");
  printf("\th - Show help.\n");
  exit(1);
}
...
int main(int argc, char *argv[]) {
  int x, i;
  char opt;
  while((opt = getopt(argc, argv, "ahrFlt:")) != END_OPT) {
    switch(opt) {
    case 'a':
      ACCIDENT = 1;
      break;
